<template>
    <div>
        ...
        <!-- <div class="container mt-5 d-flex justify-content-center" v-if="!is_user_logged">
            <div class="card card-body shadow">
                <h1 class="text-center">REGISTER</h1>
                <div class="alert alert-danger my-2 py-0" v-if="error_message != null">{{ error_message }}</div>
                <form @submit.prevent="registerForm" method="POST">
                    <div class="row">
                        <div class="col-12">
                            <label for="name">Name</label>
                            <input type="text" name="name" class="form-control" placeholder="Name" v-model="user_name" required>
                        </div>
                        <div class="col-12">
                            <label for="email">Email</label>
                            <input type="text" class="form-control" placeholder="email@email.com" v-model="user_email" required>
                        </div>
                        <div class="col-12">
